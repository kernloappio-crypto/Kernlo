...
export default function CompliancePage() {
  ...
  // Refetch attendance when arriving at compliance page (triggers on route/kidId change)
  useEffect(() => {
  ...
  // Subscribe to real-time activity changes (for auto-refresh when approved)
  useEffect(() => {
    ...
    <>
      ...
      <div style={{ backgroundColor: "white", borderBottom: "1px solid #e5e7eb" }} className="p-4 sm:p-6">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Header with State Dropdown and Warning inline */}
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
            <div className="flex-1">
              <h1 style={{ color: COLORS.dark }} className="text-3xl font-bold mb-2">
                {STATE_REQUIREMENTS[selectedState]?.name} Compliance
              </h1>
              
              {/* Inline Warning next to title */}
              <div className="inline-block">
                {allMet ? (
                  <div style={{ backgroundColor: "#e8f5e9", borderRadius: "8px" }} className="px-3 py-2 border border-green-200 inline-block">
                    <p style={{ color: "#2e7d32" }} className="text-xs font-bold">
                      ✓ All requirements met!
                    </p>
                  </div>
                ) : (
                  <div style={{ backgroundColor: "#fff3e0", borderRadius: "8px" }} className="px-3 py-2 border border-orange-200 inline-block">
                    <p style={{ color: "#e65100" }} className="text-xs font-bold">
                      ⚠️ Not all requirements met. Keep logging activities.
                    </p>
                  </div>
                )}
              </div>
            ...
            {/* State Dropdown Button (right side) */}
      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6 space-y-4 sm:space-y-6">
        {/* ATTENDANCE SUMMARY CARD (Now at top) */}
